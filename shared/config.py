...
def parse_args(product: ProductSpec | None = None) -> PdfConfig:
    ...
    parser = argparse.ArgumentParser(description=f"Generate PDF from {product.name if product else 'documentation'}")
    parser.add_argument(
        "--font-scale",
        type=int,
    ...
    parser.add_argument("--no-strip-blank", action="store_true", help="Disable trailing blank page removal")
